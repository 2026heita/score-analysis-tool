...
exports.mapLegacyFieldTypeToDataType = mapLegacyFieldTypeToDataType;
exports.mapLegacyAnalysisRoleToRole = mapLegacyAnalysisRoleToRole;
exports.mapLegacyAnalysisRoleToDirection = mapLegacyAnalysisRoleToDirection;
exports.mapLegacyFieldMetaToSchema = mapLegacyFieldMetaToSchema;
exports.mapLegacyFieldMetasToSchemas = mapLegacyFieldMetasToSchemas;
exports.mapNewDataTypeToLegacyFieldType = mapNewDataTypeToLegacyFieldType;
exports.mapNewRoleToLegacyAnalysisRole = mapNewRoleToLegacyAnalysisRole;
// ============================================================
 ...
 */
function mapLegacyFieldTypeToDataType(legacyType) {
    switch (legacyType) {
        case 'score':
        case 'rank':
        case 'bonus':
 ...
 */
function mapLegacyAnalysisRoleToRole(legacyRole) {
    switch (legacyRole) {
        case 'primaryTotal':
        case 'rank':
        case 'sectionTotal':
 ...
 */
function mapLegacyAnalysisRoleToDirection(legacyRole) {
    switch (legacyRole) {
        case 'rank':
 ...
 * @returns 新的字段模式
 */
function mapLegacyFieldMetaToSchema(fieldMeta, columnValues) {
 ...
 */
function isIdentityDimension(header) {
 ...
 * 计算字段统计信息
 */
function computeStatistics(columnValues) {
 ...
 */
function mapLegacyFieldMetasToSchemas(fieldMetas, rows) {
 ...
 */
function mapNewDataTypeToLegacyFieldType(dataType) {
    switch (dataType) {
        case 'number':
 ...
 */
function mapNewRoleToLegacyAnalysisRole(role) {
    switch (role) {
        case 'metric':
