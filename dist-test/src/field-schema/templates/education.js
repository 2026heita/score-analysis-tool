...
exports.applyEducationTemplate = applyEducationTemplate;
exports.isEducationTemplateMatch = isEducationTemplateMatch;
exports.getEducationTemplateKeywords = getEducationTemplateKeywords;
// ============================================================
// 教育模板关键词
// ============================================================
/** 成绩字段关键词 */
 ...
 */
function applyEducationTemplate(header, baseSchema) {
 ...
 * 检查字段是否匹配教育模板
 */
function isEducationTemplateMatch(header) {
    const headerLower = header.toLowerCase().trim();
    const allKeywords = [
        ...SCORE_KEYWORDS,
        ...RANK_KEYWORDS,
 ...
 */
function getEducationTemplateKeywords() {
    return {
