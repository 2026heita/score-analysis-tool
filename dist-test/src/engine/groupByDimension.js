 ...
 */
export function getAvailableDimensions(fieldMetas) {
    const results = [];
 ...
 * @returns 排序后的新数组
 */
export function sortGroupStats(stats, sortBy, sortOrder) {
 ...
 * @returns 截断后的数组
 */
export function topN(stats, topN = DEFAULT_TOP_N) {
 ...
 */
export function isMetricField(meta) {
