...
exports.getMergedHeaders = getMergedHeaders;
exports.detectAndFlattenMultiRowHeaders = detectAndFlattenMultiRowHeaders;
exports.extractSingleRowHeader = extractSingleRowHeader;
// ============================================================
...
// 简单的单行表头提取（用于非多级表头场景）
// ============================================================
function extractSingleRowHeader(rawRows, merges) {
    const grid = getMergedHeaders(rawRows, merges);
    const row = grid[0] ?? [];
    return {
