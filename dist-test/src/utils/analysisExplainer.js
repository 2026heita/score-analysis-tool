 ...
 */
export function explainField(field, userValue, values, isRankField = false) {
    // 校验 userValue 有效性
 ...
 * 为多个字段生成综合摘要
 */
export function summarizeFields(explanations) {
 ...
 */
export function generateExplanation(fieldValues, fieldData, rankFields) {
